...
public class RegistrationService {
    ...
    @Autowired
    public RegistrationService(AppCompanyService appCompanyService, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, EmailSender emailSender) {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appCompanyService.signUpCompany(
                new AppCompany(
                        request.getName(),
                        request.getEmail(),
                        request.getPassword(),
